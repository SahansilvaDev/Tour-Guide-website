...
if (isset($_POST['submit'])) {
    $target_dir = "../../img/main_slider_img/"; // Update the path as needed
    ...
    if (
        ...
        $sql = "INSERT INTO u_main_slide (file1, file2, file3, change_date) VALUES ('$imageStore1', '$imageStore2', '$imageStore3', '$date')";
