...
if (isset($_POST['submit'])) {
  ...
  $people5 = $_POST['people5'];
    ...
    $target_dir = "../../img/popular_place/"; // Update the path as needed
    ...
    if (
        ...
        $sql = "INSERT INTO user_main(file1, place1, location_name1, people1, file2, place2, location_name2, people2, file3, place3, location_name3, people3, file4, place4, location_name4, people4, file5, place5, location_name5, people5, date) 
        VALUES ('$imageStore1', '$place1', '$location_name1', '$people1', '$imageStore2', '$place2', '$location_name2', '$people2', '$imageStore3', '$place3', '$location_name3', '$people3', '$imageStore4', '$place4', '$location_name4', '$people4', '$imageStore5', '$place5', '$location_name5', '$people5', '$date')";
