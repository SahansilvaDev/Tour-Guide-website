...
if (isset($_POST['submit'])) {
  ...
  $place1 = $_POST['place1'];
  $location_name1 = $_POST['location_name1'];
  $people1 = $_POST['people1'];

  $place2 = $_POST['place2'];
  $location_name2 = $_POST['location_name2'];
  $people2 = $_POST['people2'];

  $place3 = $_POST['place3'];
  $location_name3 = $_POST['location_name3'];
  $people3 = $_POST['people3'];

  $place4 = $_POST['place4'];
  $location_name4 = $_POST['location_name4'];
  $people4 = $_POST['people4'];

  $place5 = $_POST['place5'];
  $location_name5 = $_POST['location_name5'];
  $people5 = $_POST['people5'];

  $place6 = $_POST['place6'];
  $location_name6 = $_POST['location_name6'];
  $people6 = $_POST['people6'];


  $target_dir = "../../img/travel_places/"; // Update the path as needed
  ...
  if (
    ...
    $sql = "INSERT INTO user_travel_places(file1, place1, location_name1, people1, file2, place2, location_name2, people2, file3, place3, location_name3, people3, file4, place4, location_name4, people4, file5, place5, location_name5, people5, file6, place6, location_name6, people6, date)
    VALUES ('$imageStore1', '$place1', '$location_name1', '$people1', '$imageStore2', '$place2', '$location_name2', '$people2', '$imageStore3', '$place3', '$location_name3', '$people3', '$imageStore4', '$place4', '$location_name4', '$people4', '$imageStore5', '$place5', '$location_name5', '$people5', '$imageStore6', '$place6', '$location_name6', '$people6', '$date')";

    if ($conn->query($sql) === true) {
      header("Location: ./insert_travel_places.php");
      exit();
    } else {
