...
if (isset($_POST['submit'])) {
  ...
  if (
    ...
    $sql = "INSERT INTO cityies (city, M_img1, M_img2, M_img3, M_img4, M_img5, about, date)
    VALUES ('$place1', '$imageStore1', '$imageStore2', '$imageStore3', '$imageStore4', '$imageStore5', '$location_name1', '$date')";

    if ($conn->query($sql) === true) {
      header("Location: ./insert_add_cities.php");
      exit();
    } else {
