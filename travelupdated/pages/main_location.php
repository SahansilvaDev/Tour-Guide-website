...
$sql = "SELECT * FROM  cityies  WHERE city = ?";
...
if ($result->num_rows > 0) {
  ...
  $sql = "SELECT * FROM cityies WHERE city = '$selectedTable' ";
...
<!-- end php -->
  ...
  <nav class="navbar navbar-expand-sm sticky-top navbar-light bg-light d-block d-sm-block d-md-none d-lg-none">
    <div class="container-fluid">
      <a class="navbar-brand" href="#">
        <h1 class="loc-hed"><span>Explore </span> <?php echo $selectedTable; ?></h1>
      </a>
  ...
  <div class="loc-header ">
    <div class="container">
      <div class="loc-hed pt-4  pb-2">
        <h1><span>Explore </span> <?php echo $selectedTable; ?></h1>
      </div>
    </div>
    ...
    <ul class="nav ">
      <li class="nav-item justify-content-left mx-3">
        <a class="nav-link active  loc-hed ps-2 pe-5  " aria-current="page" class="list-group-item list-group-item-action" href="#list-item-1">
          <h2><span>Explore </span><br> <?php echo $selectedTable; ?></h2>
        </a>
      </li>
        ...
        <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="../../admin/img/cities/<?php echo $row['M_img1']; ?>" class="d-block w-100  col_img_carousel loc_img " alt="...">
            ...
            <div class="carousel-item">
              <img src="../../admin/img/cities/<?php echo $row['M_img2']; ?>" class="d-block w-100 col_img_carousel  loc_img" alt="...">
            ...
            <div class="carousel-item">
              <img src="../../admin/img/cities/<?php echo $row['M_img3']; ?>" class="d-block w-100  col_img_carousel loc_img " alt="...">
      ...
      <div class="col-sm-5 p-0  mobile-side-crousel">
        <div class="col p-0">
          <div class="row-sm-6 p-0">
            <img src="../../admin/img/cities/<?php echo $row['M_img4']; ?>" class="d-block w-100  col_img_carousel_2  loc_img " alt="...">
          </div>
          <div class="row-sm-6 p-0">
            <img src="../../admin/img/cities/<?php echo $row['M_img5']; ?>" class="d-block w-100  col_img_carousel_2 loc_img " alt="...">
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    <div class="loc_about">
      <h1 class="fs-1 py-3">About <span> <?php echo $row['city']; ?></span></h1>
    </div>
...
.
  ...
  <!-- start Essential -->
   ...
   <div class="container" data-bs-spy="scroll" data-bs-target="#list-example" data-bs-offset="0" class="scrollspy-example" tabindex="0">
    ...
    <div class="loc_about">
      <h1 class="fs-1 py-3">Essential <span> <?php echo $row['city']; ?></span></h1>
    </div>
...
$sql = "SELECT * FROM places WHERE place_city = ?";
$stmt = $conn->prepare($sql);
$stmt->bind_param("s", $cityName);
$stmt->execute();
...
$result = $stmt->get_result();
    ...
    <a href="#" class="locationLink" data-location="<?php echo $row['id']; ?>">
        <div class="card" style="width: 18rem;">
            <img src="../../admin/img/place/<?php echo $row['place_img']; ?>" class="img-fluid card-img-top" alt="...">
            <div class="card-body" style="height: auto;">
                <p class="card-text py-1  my-1" style="max-width: 18rem; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
                    <?php echo $row['place_hed']; ?>
                </p>
                <div class="card-text mb-2 ">
                    <div class="main-box pb-2">
                     ...
                     <div class="para-text" style=" width:250px;  ">
                              <?php
                              $price = $row['place_price'];
                              $text =  $price;

                              if (strlen($text) > 100) {
                                  $text = substr($text, 0, 97) . '...'; // Truncate to 47 characters and add '...'
                              }
                              ?>
                              <p style="width: 100%; display: block; padding-right:5px;">
                              <?php
                               
                                $text = wordwrap($text, 37, "<br>", true);
                                echo $text;
                                ?>
    ...
    echo "No results found for $cityName.";
}
...
<?php
$sql = "SELECT * FROM things_to_do  WHERE things_to_do_city = ?";
$stmt = $conn->prepare($sql);
$stmt->bind_param("s", $cityName);
$stmt->execute();
...
?>
     ...
     <div class="col" style="width: 20rem;">
    <a href="#" class="locationLink1" data-location1="<?php echo $row['id']; ?>">
        <div class="card" style="width: 18rem;">
            <img src="../../admin/img/things_to_do/<?php echo $row['things_to_do_img']; ?>" class="img-fluid card-img-top" alt="...">
            <div class="card-body" style="height: auto;">
                <p class="card-text" style="max-width: 18rem; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
                    <?php echo $row['things_to_do_hed']; ?>
                </p>
...
?>
  ...
  <div class="container" id="list-item-4">
    <div class="row">
      ...
      <div class="col-sm-3 pt-4">
        <h2 class="loc_hed_2">Hotels & Resorts</h2>
        <p>Places to see, ways to wander, and signature experiences. <a href="" class="see_all"> See all</a></p>
      </div>
      ...
      <div class="col-sm-9">
        ...
        <div class="loc_essential scroll-bar my-5">
          <div class="row flex-nowrap">
            <!-- Your cards go here -->
          <?php
$sql = "SELECT * FROM hotels_and_resourt WHERE hotels_and_resourt_city = ?";
$stmt = $conn->prepare($sql);
$stmt->bind_param("s", $cityName);
$stmt->execute();
...
?>
        <div class="col">
           <a href="#" class="locationLink4" data-location4="<?php echo $row['id']; ?>">
            <div class="card rounded border-0 "style="max-width: 18rem;">
                <img src="../../admin/img/hotels_and_resourt/<?php echo $row['hotels_and_resourt_img']; ?>" class="img-fluid card-img-top" alt="..." >
                <div class="card-body">
                    <div class="card-text p-0">
                        <h5 class="loc-text" style="max-width: 18rem; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;"><?php echo $row['hotels_and_resourt_hed']; ?></h5>
                        <div class="main-box">
                            <div class="box item1"></div>
                            <div class="box item2"></div>
                            <div class="box item3"></div>
                           ...
                           <div class="para-text" style=" width:250px;  ">
                              <?php
                              $price = $row['hotels_and_resourt_price'];
                              $text =  $price;
...
<!-- eat end -->
  ...
  <div class="container" id="list-item-4">
    <div class="row">
      ...
      <div class="col-sm-3 pt-4">
        <h2 class="loc_hed_2">Foods  & Goods</h2>
        <p>Places to see, ways to wander, and signature experiences. <a href="" class="see_all"> See all</a></p>
      </div>
      ...
      <div class="col-sm-9">
        ...
        <div class="loc_essential scroll-bar my-5">
          <div class="row flex-nowrap">
            <!-- Your cards go here -->
          <?php
$sql = "SELECT * FROM eat WHERE eat_city = ?";
$stmt = $conn->prepare($sql);
$stmt->bind_param("s", $cityName);
$stmt->execute();
...
?>
        <div class="col">
          <a href="#" class="locationLink2" data-location2="<?php echo $row['id']; ?>">
            <div class="card rounded border-0" style="max-width: 18rem;">
                <img src="../../admin/img/eat/<?php echo $row['eat_img']; ?>" class="img-fluid card-img-top" alt="..." >
                <div class="card-body">
                    <div class="card-text p-0">
                        <h5 class="loc-text" style="max-width: 18rem; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;" ><?php echo $row['eat_hed']; ?></h5>
                        <div class="main-box">
                            <div class="box item1"></div>
                            <div class="box item2"></div>
                            <div class="box item3"></div>
...
<div class="container" id="list-item-5">
  <div class="row">
    ...
    <div class="col-sm-3 pt-4">
      <h2 class="loc_hed_2">restaurants & cafe</h2>
      <p>Places to see, ways to wander, and signature experiences. <a href="" class="see_all"> See all</a></p>
    </div>
  ...
  <div class="loc_essential scroll-bar my-5">
    <div class="row flex-nowrap">
      <!-- Your cards go here -->
      <?php
$sql = "SELECT * FROM resturent WHERE resturent_city = ?";
$stmt = $conn->prepare($sql);
$stmt->bind_param("s", $cityName);
$stmt->execute();
...
?>
        <div class="col">
           <a href="#" class="locationLink3" data-location3="<?php echo $row['id']; ?>">
            <div class="card rounded border-0" style="max-width: 18rem; ">
                <img src="../../admin/img/ressturents/<?php echo $row['resturent_img']; ?>" class="img-fluid card-img-top" alt="..." >
                <div class="card-body">
                    <div class="card-text p-0">
                        <h5 class="loc-text" style="max-width: 18rem; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;"><?php echo $row['resturent_hed']; ?></h5>
                        <div class="main-box">
                            <div class="box item1"></div>
                            <div class="box item2"></div>
                            <div class="box item3"></div>
...
locationLinks.forEach(function(link) {
    link.addEventListener("click", function(event) {
        ...
        // var url = "location_post.php?location=" + encodeURIComponent(locationName);
           ...
           var url = "../pages/places_post.php?locationId=" + encodeURIComponent(locationId);
...
var locationLinks = document.querySelectorAll(".locationLink1");
...
locationLinks.forEach(function(link) {
    link.addEventListener("click", function(event) {
        ...
        var locationId = this.getAttribute("data-location1");

        
        // var url = "location_post.php?location=" + encodeURIComponent(locationName);
					// 	var url1 = "../location_post.php?location=" + encodeURIComponent(locationName);
        
           var url = "../pages/things_to_do_post.php?locationId=" + encodeURIComponent(locationId);
...
var locationLinks = document.querySelectorAll(".locationLink2");
...
locationLinks.forEach(function(link) {
    link.addEventListener("click", function(event) {
        ...
        var locationId = this.getAttribute("data-location2");

        
        // var url = "location_post.php?location=" + encodeURIComponent(locationName);
					// 	var url1 = "../location_post.php?location=" + encodeURIComponent(locationName);
        
           var url = "../pages/eat_post.php?locationId=" + encodeURIComponent(locationId);
...
var locationLinks = document.querySelectorAll(".locationLink3");
...
locationLinks.forEach(function(link) {
    link.addEventListener("click", function(event) {
        ...
        var locationId = this.getAttribute("data-location3");

        
        // var url = "location_post.php?location=" + encodeURIComponent(locationName);
					// 	var url1 = "../location_post.php?location=" + encodeURIComponent(locationName);
        
           var url = "../pages/hotelsandresturent_post.php?locationId=" + encodeURIComponent(locationId);
...
var locationLinks = document.querySelectorAll(".locationLink4");
...
locationLinks.forEach(function(link) {
    link.addEventListener("click", function(event) {
        ...
        var locationId = this.getAttribute("data-location4");

        
        // var url = "location_post.php?location=" + encodeURIComponent(locationName);
					// 	var url1 = "../location_post.php?location=" + encodeURIComponent(locationName);
        
           var url = "../all_hotels_post.php?locationId=" + encodeURIComponent(locationId);
...
<?php 
    ...
    echo "No results found for Colombo.";
}
$stmt->close();
$conn->close();
?>
