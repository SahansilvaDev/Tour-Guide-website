...
<?php include './post_header.php'; ?>
            ...
            <div class="main_section">
                <div class="main_section_img">
                    <img src="../../admin/img/place/<?php echo $row['pl_img1']; ?>" alt="">
                    <div class="main_section_text">
                        <h1><?php echo $row["place_city"]; ?></h1>
                    </div>
                </div>
            </div>
            ...
            <div class="main_section_hed w3-row">
                <div class="w3-container " style="text-shadow:1px 1px 0 #444; margin-left: 50px;">
                    <div class="w3-col s5  w3-left">
                        <h1 style="font-family: Tahoma, 'Trebuchet MS', sans-serif;text-transform: capitalize;"><?php echo $row["place_hed"]; ?></h1>
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/eurd0WONOdw?si=SN6b5A4vwqkqTrQ7" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                ...
                <div class="slide2 cloumn">
                    <div class="container">
                        <div class="mySlides">
                            ...
                            <img src="../../admin/img/place/<?php echo $row['pl_img1']; ?>"
                                style="width:100%; " >
                        </div>
       ...
       <div class="mySlides">
          ...
          <img src="../../admin/img/place/<?php echo $row['pl_img2']; ?>" style="width:100%">
        </div>

        <div class="mySlides">
          <div class="numbertext">3 / 10</div>
          <img src="../../admin/img/place/<?php echo $row['pl_img3']; ?>" style="width:100%">
        </div>

        <div class="mySlides">
          <div class="numbertext">4 / 10</div>
          <img src="../../admin/img/place/<?php echo $row['pl_img4']; ?>" style="width:100%">
        </div>

        <div class="mySlides">
          <div class="numbertext">5 / 10</div>
          <img src="../../admin/img/place/<?php echo $row['pl_img5']; ?>" style="width:100%">
        </div>

        <div class="mySlides">
          <div class="numbertext">6 / 10</div>
          <img src="../../admin/img/place/<?php echo $row['pl_img6']; ?>"style="width:100%">
        </div> 

         <div class="mySlides">
          <div class="numbertext">7 / 10</div>
          <img src="../../admin/img/place/<?php echo $row['pl_img7']; ?>"style="width:100%">
        </div> 

         <div class="mySlides">
          <div class="numbertext">8 / 10</div>
          <img src="../../admin/img/place/<?php echo $row['pl_img8']; ?>"style="width:100%">
        </div> 

         <div class="mySlides">
          <div class="numbertext">9 / 10</div>
          <img src="../../admin/img/place/<?php echo $row['pl_img9']; ?>"style="width:100%">
        </div> 

         <div class="mySlides">
          <div class="numbertext">10 / 10</div>
          <img src="../../admin/img/place/<?php echo $row['pl_img10']; ?>"style="width:100%">
        </div> 
        ...
        <div class="row scroll-bar">
          <div class="column">
            <img class="demo cursor" src="../../admin/img/place/<?php echo $row['pl_img1']; ?>"style="width:100%; height:100px;" onclick="currentSlide(1)" alt="">
          </div>
          <div class="column">
            <img class="demo cursor"
              src="../../admin/img/place/<?php echo $row['pl_img2']; ?>"style="width:100%; height:100px;"
              onclick="currentSlide(2)" alt="">
          </div>
          <div class="column">
            <img class="demo cursor"
              src="../../admin/img/place/<?php echo $row['pl_img3']; ?> " style="width:100%; height:100px;" onclick="currentSlide(3)" alt="">
          </div>
          <div class="column">
            <img class="demo cursor" src="../../admin/img/place/<?php echo $row['pl_img4']; ?> "style="width:100%; height:100px;"
              onclick="currentSlide(4)" alt="">
          </div>
          <div class="column">
            <img class="demo cursor"
              src="../../admin/img/place/<?php echo $row['pl_img5']; ?>"style="width:100%; height:100px;" onclick="currentSlide(5)" alt="">
          </div>
          <div class="column">
            <img class="demo cursor" src="../../admin/img/place/<?php echo $row['pl_img6']; ?>"style="width:100%; height:100px;" onclick="currentSlide(6)" alt="Snowy Mountains">
          </div>
          <div class="column">
            <img class="demo cursor" src="../../admin/img/place/<?php echo $row['pl_img7']; ?> "style="width:100%; height:100px;"
              onclick="currentSlide(7)" alt="Snowy Mountains">
          </div>
          <div class="column">
            <img class="demo cursor"
              src="../../admin/img/place/<?php echo $row['pl_img8']; ?> "style="width:100%; height:100px;" onclick="currentSlide(8)" alt="Snowy Mountains">
          </div>
          <div class="column">
            <img class="demo cursor"
              src="../../admin/img/place/<?php echo $row['pl_img9']; ?> "style="width:100%; height:100px;" onclick="currentSlide(9)" alt="Snowy Mountains">
          </div>
          <div class="column">
            <img class="demo cursor"
              src="../../admin/img/place/<?php echo $row['pl_img10']; ?> "style="width:100%; height:100px;" onclick="currentSlide(10)" alt="Snowy Mountains">
          </div>
        </div>
                    </div>
      </div>
 ...
 <div class="ss_about">
        <h2 >About <span style="text-transform: capitalize;"><?php echo $row["place_hed"]; ?></span></h2>
      </div>

           <p class="second_section_para"><?php echo $row['pl_text']; ?></p>
    ...
    <div class="map w3-container">
      <footer class="w3-container ">
        <h5>Best Location</h5>
          ...
          <p class="second_section_para">
            <iframe src="<?php echo $row['pl_map']; ?>" width="100%" height="450" style="border:0;" allowfullscreen=""  referrerpolicy="no-referrer-when-downgrade"></iframe>
          </p>
