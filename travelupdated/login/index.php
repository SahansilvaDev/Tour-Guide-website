    ...
    <div class="left">
      <div class="header">
        <h2 class="animation a1">Welcome Back</h2>
         <div class="set_social">
            <iframe src="./login_icon.php" scrolling="no" width="100%" height="60px" frameborder="0" id="myiframe"></iframe>
 

         </div>
        <h4 class="animation a2">Log in to your account using your email address and password</h4>
        <h6 class="animation a2" style="color:white;">If you do not have an account, please <a href="./reg.php">register</a></h6>
      </div>
